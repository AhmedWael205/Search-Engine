...
public class searchQuery extends HttpServlet
{
	...
	public void service(HttpServletRequest req, HttpServletResponse res) throws IOException
	{
		...
		String Search_Query = req.getParameter("query");
            ...
            else if (!unfinished)
            {
	            ...
	            if(!ImageSearch) {
		            ...
		            while( j < URLperPage*str && j < QPRes.size())
		            {
		                ...
		                {
		                	String x = "(?i)"+Search_Query;
		                	String y = "<b>"+FoundQuery+" </b>";
		                	Snippet=Snippet.replaceAll(x,y);
		                }
	            ...
	            for(int i=1; i <= end; i++)
	            {
	                if(Integer.toString(i).equals(pageNumber))
	                    ...
	                    out.println(    "    <li><a href='?query="+Search_Query+"&imageSearch="+ImageOn+"&country="+Country+"&pageNumber="+i+"'>"+i+"</a></li>\n" );
	            }
...
//        System.out.println(printCountries);
    ...
    private void initNAMES()
    {
    	if(NAMES.size() != 0) return;
		 try(BufferedReader reader = new BufferedReader(new FileReader(("D:/University Materials/CMPN courses/Advanced Programming Techniques/Spring 2020/Project/SearchEngine/src/names.txt")))){
	            while(reader.ready())
